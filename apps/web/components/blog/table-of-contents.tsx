...
export function TableOfContentsList({ items, onNavigate }: TableOfContentsListProps) {
  ...
  return (
    <div className="glass-card rounded-[1.75rem] p-5">
      <nav aria-label="Table of contents">
        <p className="text-xs font-semibold tracking-[0.24em] text-muted uppercase">{label}</p>
